...
class BlockedServer {
  ...
  factory BlockedServer.parse(String addressSha1) {
    final crackedAddress = _knownCrackedServers
        .where((server) => server.addressSha1 == addressSha1);
  ...
  static const Set<BlockedServer> _knownCrackedServers = <BlockedServer>{
    ...
    BlockedServer('65ca8860fa8141da805106c0389de9d7c17e39bf',
        '*.howdoiblacklistsrv.host'),
    BlockedServer('7dca807cc9484b1eed109c003831faf189b6c8bf',
        '*.brandonlovescock.online'),
    BlockedServer(
    ...
    BlockedServer('48f04e89d20b15de115503f22fedfe2cb2d1ab12',
        'brandonisan.unusualperson.com'),
    BlockedServer('9f0f30820cebb01f6c81f0fdafefa0142660d688',
        '*.kidslovemy500dollarranks.club'),
    BlockedServer(
        'cc90e7b39112a48064f430d3a08bbd78a226d670', '*.eccgamers.com'),
    BlockedServer(
        '88f155cf583c930ffed0e3e69ebc3a186ea8cbb7', '*.fucktheeula.com'),
    BlockedServer('605e6296b8dba9f0e4b8e43269fe5d053b5f4f1b',
        '*.mojangendorsesbrazzers.webcam'),
    BlockedServer('5d2e23d164a43fbfc4e6093074567f39b504ab51',
        'touchmybody.redirectme.net'),
    BlockedServer('f3df314d1f816a8c2185cd7d4bcd73bbcffc4ed8',
    ...
    BlockedServer('4a1b3b860ba0b441fa722bbcba97a614f6af9bb8',
        'justgiveinandblockddnsbitches.ddns.net'),
    BlockedServer('b8c876f599dcf5162911bba2d543ccbd23d18ae5',
        'brandonisagainst.health-carereform.com'),
    BlockedServer('9a9ae8e9d0b6f3bf54c266dcd1e4ec034e13f714',
        'brandonwatchesporn.onthewifi.com'),
    BlockedServer('336e718ffbc705e76b4a72884172c6b95216b57c',
        'canyouwildcardipsplease.gotdns.ch'),
    BlockedServer('27cf97ecf24c92f1fe5c84c5ff654728c3ee37dd',
        'letsplaysome.servecounterstrike.com'),
    BlockedServer('32066aa0c7dc9b097eed5b00c5629ad03f250a2d',
        'mojangbrokeintomy.homesecuritymac.com'),
